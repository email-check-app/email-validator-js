...
import { amazonCaData } from './0303-domain-whois-data/amazon-ca-data';
import { bbcCoUkData } from './0303-domain-whois-data/bbc-co-uk-data';
import { googleOrgData } from './0303-domain-whois-data/google-org-data';
import { inMtData } from './0303-domain-whois-data/in-mt-data';
import { meIoData } from './0303-domain-whois-data/me-io-data';
import { meabedComData } from './0303-domain-whois-data/meabed-com-data';
import { roleAiData } from './0303-domain-whois-data/role-ai-data';
import { wikipediaOrgData } from './0303-domain-whois-data/wikipedia-org-data';
